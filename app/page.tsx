      ...
      <div className="flex min-h-screen">
        <aside className="hidden w-[236px] shrink-0 flex-col border-r border-border glass-sidebar lg:flex">
          <div className="flex h-[72px] items-center gap-3 border-b border-border px-5">
            <div className="flex size-8 items-center justify-center rounded-lg bg-emerald-600 text-primary-foreground"><ShieldCheck className="size-[18px]" /></div>
          ...
          <div className="flex flex-1 flex-col px-3 py-5">
            ...
            <div className="mt-auto rounded-lg border border-border glass-panel p-3">
              ...
              <div className="h-1.5 overflow-hidden rounded-full bg-muted"><div className="h-full w-3/5 rounded-full bg-emerald-600" /></div>
