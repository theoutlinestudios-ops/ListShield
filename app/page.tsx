      ...
      <div className="flex min-h-screen">
        <aside className="hidden w-[236px] shrink-0 flex-col border-r border-border bg-sidebar lg:flex">
          <div className="flex h-[72px] items-center gap-3 border-b border-border px-5">
            <div className="flex size-8 items-center justify-center rounded-lg bg-primary text-primary-foreground"><ShieldCheck className="size-[18px]" /></div>
          ...
          <div className="flex flex-1 flex-col px-3 py-5">
            ...
            <div className="mt-auto rounded-lg border border-border bg-card p-3">
              ...
              <div className="h-1.5 overflow-hidden rounded-full bg-muted"><div className="h-full w-3/5 rounded-full bg-primary" /></div>
              <button onClick={() => setModal(true)} className="mt-3 flex items-center gap-1 text-[11px] font-medium text-primary">Unlock unlimited scans <ArrowRight className="size-3" /></button>
            </div>
          </div>
